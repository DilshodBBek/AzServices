...
namespace Identity.Infrastructure.Migrations
{
    ...
    [Migration("20231221140643_regionaddedtodatabase")]
    partial class regionaddedtodatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.Domain.Models.DistrictEntity", b =>
                {
                    b.Property<int>("DistrictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Identity.Domain.Models.RegionEntity", b =>
                {
                    b.Property<int>("RegionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Identity.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Identity.Domain.Models.DistrictEntity", "District")
                        .WithMany()
                        .HasForeignKey("Districtid");

                    b.HasOne("Identity.Domain.Models.RegionEntity", "Region")
                        .WithMany()
